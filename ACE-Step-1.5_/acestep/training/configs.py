...
class TrainingConfig:
    ...
    # LoRA metadata (trigger tag for activation)
    trigger_tag: str = ""
    tag_position: str = "prepend"  # "prepend" or "append"
    
    # Data loading
    # num_workers=0 on Windows: avoids slow multiprocessing spawn overhead
    # Preprocessed .pt files load from SSD in milliseconds, no workers needed
    num_workers: int = 0
